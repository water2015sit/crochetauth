...
import 'package:crochetauth/custom_input_field.dart';
import 'package:crochetauth/page_header.dart';
import 'package:crochetauth/forget_password_page.dart';
import 'package:crochetauth/signup_page.dart';
import 'package:email_validator/email_validator.dart';
import 'package:crochetauth/page_heading.dart';

import 'package:crochetauth/custom_form_button.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _handleLoginUser() {
    ...
    if (_loginFormKey.currentState!.validate()) {
      ...
      setState(() {
        _errorMessage = 'Error: cannot log in'; // Set the error message
      });
    }
  }
}